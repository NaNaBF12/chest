...
-- 🌸 PINK THEME
local THEME_PINK = Color3.fromRGB(255, 140, 180)      -- hồng chính
local THEME_PINK_LIGHT = Color3.fromRGB(255, 170, 200) -- hồng nhạt
...
Top_1.Text = "NaNa Hub farm chest"
...
UIGradient_1.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0, THEME_PINK),
    ColorSequenceKeypoint.new(1, THEME_PINK_LIGHT)
}
...
DropShadow_1.Image = "rbxassetid://92120582532478"
...
dutdit.BackgroundColor3 = THEME_PINK_LIGHT
...
ImageLabel.Image = "rbxassetid://92120582532478"  
...
for i, v in ipairs(lines) do
    ...
    lb.Parent = gui
    lb.Text = v
    lb.Size = UDim2.new(0, 300, 0, 30)
    lb.Position = UDim2.new(0.5, -150, 0, 50 + (i * 35))
